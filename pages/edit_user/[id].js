    ...
    return (
        <div className="edit_user my-3">
            ...
            <div className="col-md-4 mx-auto my-3">
                ...
                <div className="form-group">
                    <label htmlFor="name" className="d-block">Email</label>
                    <input type="text" id="email" defaultValue={editUser.email} disabled/>
                </div>

                <div className="form-group">
                    <input type="checkbox" id="isAdmin" checked={checkAdmin} style={{width: '20px', height: '20px'}}
                        onChange={handleCheck}/>
                    <label htmlFor="isAdmin" style={{transform: 'translate(4px, -3px)', marginLeft: '3px'}}> isAdmin</label>
                </div>
